    ...
    <div className="m-3">
      <div className="flex justify-between">
        ...
        <div className="ml-6 flex flex-1 gap-x-3">
          <div className="flex cursor-pointer select-none items-center gap-x-2 rounded-md bg-white py-2 px-4 text-black hover:bg-blue-100">
        ...
        <div className="ml-2 flex">
          ...
          <div className="flex m-1 cursor-pointer items-center gap-x-1 rounded-md py-2 px-4 hover:bg-gray-100">
          ...
          <button className="py-3 px-5 m-1 flex cursor-pointer items-center gap-x-1 rounded-md bg-blue-100 hover:bg-gray-100" onClick={toggleSidebar}>
            {loginLoading ?
